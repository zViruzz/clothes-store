...
const stylesSlots = tv({
  slots: {
    ...
    contentLinks:
      'flex flex-col gap-4 [&_h4]:text-[27px] [&_h4]:font-medium [&_ul]:flex [&_ul]:flex-col [&_ul]:gap-2 [&_a]:flex [&_a]:gap-2 [&_a]:items-center [&_a]:text-neutral-600 [&_a]:hover:text-black',
